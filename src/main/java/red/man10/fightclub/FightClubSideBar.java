...
public class FightClubSideBar {
    ...
    void showOdds(){
        ...
        sideBar.setScore("§e "+plugin.fighters.get(0).name+" Kill:"+plugin.kill0 + " Death:"+plugin.death0+" $"+plugin.prize0 ,0);
        sideBar.setScore("§e "+plugin.fighters.get(1).name+" Kill:"+plugin.kill1 + " Death:"+plugin.death1+" $"+plugin.prize1 ,0);
